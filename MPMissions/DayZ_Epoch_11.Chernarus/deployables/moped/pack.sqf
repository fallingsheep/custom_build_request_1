if (false) then { 
// player is in combat and cant pack his moped
	...
	// delete it first to avoid player changing to another target
		...
		sleep 6;
		cutText [format["You have packed your Moped and been given back your materials"], "PLAIN DOWN"];
		r_interrupt = false;
		player switchMove "";
		player playActionNow "stop";
	} else {
		// player is not looking at a mopde, or target does not have a bike classname
		cutText [format["You have to be facing your Moped to re-pack it!"], "PLAIN DOWN"];
	};
};